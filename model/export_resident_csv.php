...
fputcsv($output, array('National ID', 'First Name','Middle Name', 'Last Name', 'Alias', 'Birtplace', 'Birthdate', 'Age', 'Civil Status', 'Gender', 'Barangay', 'Voter Status', 'Identified As', 'Contact Number', 'Email Address', 'Address'));

...
<?php 
	$query = "SELECT * FROM tbl_bp ORDER BY id DESC";
...
<body>
									...
									<div class="card-head-row">
                                        ...
                                        <div class="card-tools">
											<?php if(isset($_SESSION['username']) && $_SESSION['role']!='resident'): ?>
												<a href="bp-add.php" class="btn btn-primary mr-1">
												...
												<?php if(!empty($resident)): ?>
													<?php $no=1; foreach($resident as $row): ?>
                                                        <tr>
															...
															<td><?= $row['dateofbp'] ?></td>
                                                            <td>
																<a href="bp-update.php?id=<?= $row['id'] ?>" class="btn btn-link" data-toggle="tooltip" data-placement="top" title="Update">
    ...
    <script>
        ...
        function Export(){
			...
			var stmt = "SELECT p_name,birthdate,age,gender,address,sbp,dbp,dateofbp,phone,remarks FROM tbl_bp";
			var tblHeader = 'Patient Name,Birth Date,Age,Gender,Address,Systolic Blood Pressure,Diastolic Blood Pressure,Date,Contact Number,Remarks';
			var fileName = "Blood Pressure Records";
			if(conf){
